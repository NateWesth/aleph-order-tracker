...
-- Assignment notifications, separate from the normal order owner.
...
-- Truly automatic routing/assignment when an item first enters the ready-for-fulfillment bucket.
