-- Emoji reactions on comments currently notify no one. Add the missing
-- trigger so reacting to someone's comment lets them know, the same way
-- replies and mentions already do.
