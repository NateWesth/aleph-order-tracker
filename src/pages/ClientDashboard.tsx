  ...
  return <SidebarProvider>
      <div className="min-h-screen w-full flex bg-black dark:bg-black">
        ...
        <Sidebar className="dark:bg-black bg-white">
          <SidebarContent className="relative bg-[#162014]">
            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Processing" onClick={() => handleMenuClick("processing")} className={`sidebar-hover ${activeView === "processing" ? "sidebar-active" : ""} text-slate-50`}>
                  <FileText />
